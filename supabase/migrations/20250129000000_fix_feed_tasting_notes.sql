-- Fix feed_with_details view to properly join tastings with time window
-- This ensures tasting notes and ratings appear in feed items
-- Uses 10-second time window to match tasting with activity_feed entry
