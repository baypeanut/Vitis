-- Feed-Tasting join determinism: add tasting_id to activity_feed for had_wine.
-- New tastings will set this; legacy rows remain NULL (view fallback to time window).

ALTER TABLE public.activity_feed
ADD COLUMN IF NOT EXISTS tasting_id uuid REFERENCES public.tastings(id) ON DELETE CASCADE;
