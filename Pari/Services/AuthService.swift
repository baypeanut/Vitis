...
private extension Logger {
    static let auth = Logger(subsystem: "com.ahmet.pari", category: "AuthService")
}

enum AuthService {
    static var supabase: SupabaseClient { SupabaseManager.shared.supabase }
    private static let emailRedirectURL = URL(string: "pari://auth-callback")!
    ...
    /// If a real session exists, post ready and return. Else ensure pari_dev_user_id (or mock), then post.
