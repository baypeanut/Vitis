...
enum MuteService {
    private static let key = "pari_muted_user_ids"
    ...
    private static func save(_ ids: Set<UUID>) {
        ...
        NotificationCenter.default.post(name: .pariMuteListChanged, object: nil)
    }
}

extension Notification.Name {
    static let pariMuteListChanged = Notification.Name("pariMuteListChanged")
}
