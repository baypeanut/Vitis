        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                ...
                section("1. About Pari") {
                    body("Pari is a social wine journal. We help you log tastings, discover wines through friends, and build your personal taste profile. Pari is not a wine retailer, marketplace, or alcohol delivery service. We do not sell, ship, or facilitate the purchase of alcohol.")
                }
                ...
                section("2. Eligibility") {
                    ...
                    body("Pari is available globally where Apple distributes apps. Local laws regarding alcohol and social platforms vary. You are responsible for compliance with laws in your jurisdiction.")
                }
                ...
                section("4. User-Generated Content") {
                    ...
                    body("You retain ownership of your Content. By posting, you grant Pari a worldwide, royalty-free, non-exclusive license to store, display, and distribute your Content within the app and for promotional purposes (e.g., App Store screenshots).")
                ...
                section("5. Acceptable Use") {
                    body("You agree not to: (a) scrape, crawl, or extract data from Pari; (b) reverse-engineer or decompile the app; (c) use Pari to harass, threaten, or harm other users; (d) attempt to gain unauthorized access to our systems; (e) interfere with the performance of the service.")
                }
                ...
                section("8. Disclaimers") {
                    body("Pari is provided \"as is\" and \"as available.\" We do not warrant that the service will be uninterrupted, error-free, or free from viruses.")
                    body("Wine ratings and tasting notes are personal opinions of individual users. Pari does not endorse any wine, producer, or tasting note.")
                    body("Alcohol consumption carries health risks. Nothing in Pari constitutes medical or dietary advice. Drink responsibly.")
                }

                section("9. Limitation of Liability") {
                    body("To the maximum extent permitted by applicable law, Pari and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service.")
                ...
                section("11. Changes to These Terms") {
                    body("We may update these Terms from time to time. We will notify you of material changes via in-app notice or email. Continued use of Pari after the effective date constitutes acceptance of the updated Terms.")
                }
                ...
                section("13. Contact") {
                    body("Questions about these Terms? Reach us at support@pari.app or through Settings → Contact Concierge.")
                }
