...
struct OnboardingFlowView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .onReceive(NotificationCenter.default.publisher(for: .pariDeepLinkResetPassword)) { _ in
                showDevLogin = false
            }
            .onReceive(NotificationCenter.default.publisher(for: .pariShowLogIn)) { _ in
                showDevLogin = true
            }
